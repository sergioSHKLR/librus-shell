...
const I18N = {
  pt: {
    ...
    "ctx.hintBody":
      "Selecione um termo no painel Leia e clique num provedor acima (Enciclopédia, Dicionário, Outro, etc). Também pode usar um link existente — a consulta abre neste painel.",
  ...
  en: {
    ...
    "ctx.hintBody":
      "Select a term in the Read pane and click a provider above (Encyclopedia, Dictionary, Other, etc). You can also use an existing link — the result opens in this pane.",
