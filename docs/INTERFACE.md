# Interface freeze — v0.9.9

**Date:** 2026-09-10  
**Version:** `0.9.9` BETA  
**Repo:** `librus-shell` (build step 3 of 4)

Chrome, Help, flavors, and Consulte empty-state are **frozen**. Do not add panes, bar items, Help beats, or flavor marks without an explicit unfreeze. Book HTML/CSS and editorial Markdown are **not** frozen.
...
5. **BETA** — Settings → Sobre, next to `v0.9.9`.  
